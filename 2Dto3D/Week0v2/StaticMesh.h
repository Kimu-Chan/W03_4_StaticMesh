...
public:
    ...
    FStaticMesh(ID3D11Buffer* vb, UINT vCount, FVertexSimple* vertexData,
        ID3D11Buffer* ib = nullptr, UINT iCount = 0, UINT* indexData = nullptr)
        ...
        if (vertexData) {
            ...
            UE_LOG(LogLevel::Display, FString("cpy").c_str());
        }
